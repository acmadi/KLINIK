...
Public Class FormBahanMentahHistory
    ...
    Private Sub setData(ByVal sql As String)
        ...
        While reader.read
            ...
            txtTipe.Text = reader("NamaBahanMentahTipe").ToString
            txtSubKategori.Text = reader(3).ToString
    ...
    Private Sub viewAllData(ByVal cr As String, ByVal opt As String)
        sql = " select msbahanmentah.KdBahanMentah 'No. Part', " & _
              " NamaBahanMentah Nama,NamaBahanMentahTipe, " & _
              ...
              " Join msbahanmentahtipe mbt On mbt.KdBahanMentahTipe = " & tab & ".KdBahanMentahTipe " & _
