...
Public Class FormFisingHistory
    ...
    Private Sub setData(ByVal sql As String)
        ...
        Dim sql_history = " select ifNull(sum(QtyRetur_Min),0) Retur, " & _
                          ...
                          " from Fisinghistory where StatusFisingList <> 1 and KdFising = '" & txtID.Text & "' "
    ...
    Private Sub viewAllData(ByVal cr As String, ByVal opt As String)
        sql = " select msFising.KdFising 'No. Part', " & _
              " TypeFising tipe,JenisFising jenis, " & _
              " ifnull(( Select StockAkhir from Fisinghistory " & _
              " where isActive = 1 And KdFising = " & tab & ".KdFising " & _
              " order by KdFisingHistory desc limit 1 ),0) Stock " & _
              " from  " & tab & _
        ...
        Dim sql_stock = " select DATE_FORMAT(TanggalHistory,'%d %M %Y') Tanggal, StockAwal 'Stock Awal', " & _
                        ...
                        " Where Fisinghistory.KdFising = '" & PK & "' "
    ...
    Private Sub viewAllDataProd(ByVal cr As String, ByVal opt As String)
        Dim sql_stock = " select RefNumber 'No. Produksi', " & _
                        ...
                        " from Fisinghistory " & _
                        " Where Fisinghistory.KdFising = '" & PK & "' " & _
