...
Public Class FormMsArea
    ...
    Private Sub viewAllData(ByVal cr As String, ByVal opt As String)
        sql = " select kdArea Kode,NamaArea 'Nama Area' " & _
              " from  " & tab & _
              " Where 1 "

        If opt <> "" Then
            Dim col As String = ""
            If opt = "Nama Area" Then
                col = "NamaArea"
            End If
            sql &= "  And " & col & "  like '%" & cr & "%'  and kdArea <>'AR00000000' "
        Else
            sql &= "  And kdArea <>'AR00000000' "
        End If
        sql &= " Order By NamaArea "
    ...
    Private Sub generateCode()
        ...
        Dim reader = getCode("MsArea", "KdArea")
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            ElseIf status = "update" Then
                Try
                    sql = "update   " & tab & "  set  NamaArea='" & Trim(txtNama.Text) & "' where  " & PK & "='" + txtID.Text + "' "
                    execute_update(sql)
                    viewAllData("", "")
                    ubahAktif(False)
