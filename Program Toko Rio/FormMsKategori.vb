...
Public Class FormMsKategori
    ...
    Private Sub FormMsKategori_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        FormMsBarang.setCmbKategori()
        'FormMsBarang.Timer1.Enabled = True

        'FormMsBarang.FormMsBarang_Load(Nothing, Nothing)
    End Sub
