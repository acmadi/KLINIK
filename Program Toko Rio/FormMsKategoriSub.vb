...
Public Class FormMsKategoriSub
    ...
    Private Sub generateCode()
        ...
        Dim kode As String
        Dim reader = getCode("mssubkategori", "KdSub")
    ...
    Private Sub viewAllData(ByVal cr As String)
        sql = "select KdSub 'Kode Sub Kategori',Subkategori 'Sub Kategori' from  " & tab & "  t "
        If cr <> "" Then
            sql = sql & "  where Subkategori like '%" & cr & "%'"
        End If
    ...
    Private Sub FormMsMerk_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        'End If
        'reader.Close()
        'FormMsBarang.setCmbSubKategori()
        FormMsBarang.Timer1.Enabled = True
    End Sub
    Private Sub FormMsKategoriSub_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        tab = " MsSubKategori "
        PK = "  KdSub  "
        ubahAktif(False)
        viewAllData("")
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If MsgBox("Apakah Anda yakin ingin menghapus sub kategori " & txtNoPolisi.Text & "?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Confirmation") = MsgBoxResult.Yes Then
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            If status = "add" Then
                Try
                    Dim reader = execute_reader("Select * from " & tab & " where subkategori='" & Trim(txtNoPolisi.Text) & "'")
                    If reader.Read Then
                        msgInfo("Sub kategori ini telah ada di dalam database")
                        txtNoPolisi.Text = ""
                        txtNoPolisi.Focus()
                        reader.Close()
                    Else
            ...
            ElseIf status = "update" Then
                Try
                    sql = "update   " & tab & "  set subkategori='" & Trim(txtNoPolisi.Text) & "'" & _
                    "  where  " & PK & "='" + txtID.Text + "' "
                    execute_update(sql)
                    viewAllData("")
                    ubahAktif(False)
