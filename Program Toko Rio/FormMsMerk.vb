...
Public Class FormMsMerk
    ...
    Private Sub viewAllData(ByVal cr As String)
        sql = "select KdMerk,Merk from  " & tab
        If cr <> "" Then
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If txtNoPolisi.Text <> "" Then
            ...
            If MsgBox("Apakah Anda yakin ingin menghapus merk " & txtNoPolisi.Text & "?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Confirmation") = MsgBoxResult.Yes Then
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            If status = "add" Then
                Try
                    Dim reader = execute_reader("Select * from msmerk where merk='" & Trim(txtNoPolisi.Text) & "'")
                    If reader.Read Then
            ...
            ElseIf status = "update" Then
                Try
                    sql = "update   " & tab & "  set Merk='" & Trim(txtNoPolisi.Text) & "'" & _
                    "  where  " & PK & "='" + txtID.Text + "' "
                    execute_update(sql)
                    viewAllData("")
                    ubahAktif(False)
