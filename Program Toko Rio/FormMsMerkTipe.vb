...
Public Class FormMsMerkTipe
    ...
    Private Sub generateCode()
        ...
        Dim kode As String
        Dim reader = getCode("msmerkTipe", "kdTipe")
    ...
    Private Sub viewAllData(ByVal cr As String)
        sql = "select KdTipe,Tipe from  " & tab & "  t"
        If cr <> "" Then
            sql = sql & "  where Tipe like '%" & cr & "%'"
        End If
    ...
    End Sub
    Private Sub FormMsMerkTipe_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        tab = " MsMerkTipe "
        PK = "  KdTipe  "
        ubahAktif(False)
        viewAllData("")
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If MsgBox("Apakah Anda yakin ingin menghapus tipe " & txtNoPolisi.Text & "?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Confirmation") = MsgBoxResult.Yes Then
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Else
            ...
            If status = "add" Then
                Try
                    Dim reader = execute_reader("Select * from " & tab & " where tipe='" & Trim(txtNoPolisi.Text) & "'")
                    If reader.Read Then
                        msgInfo("Tipe ini telah ada di dalam database")
                        txtNoPolisi.Text = ""
                        txtNoPolisi.Focus()
                        reader.Close()
                    Else
            ...
            ElseIf status = "update" Then
                Try
                    sql = "update   " & tab & "  set tipe='" & Trim(txtNoPolisi.Text) & "'" & _
                    "  where  " & PK & "='" + txtID.Text + "' "
                    execute_update(sql)
                    viewAllData("")
                    ubahAktif(False)
