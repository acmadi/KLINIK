...
Public Class FormLapPembayaranPiutang
    ...
    Private Sub initGrid(ByVal s As String, ByVal s2 As String) 'area,toko
        ...
        query = " select 	KdSalesPayment `No Pembayaran`,DATE_FORMAT(TanggalSalesPayment,'%d/%m/%Y') `Tgl Pembayaran`,NamaToko `Nama Toko`,FORMAT(TotalSalesPayment,0) `Total Pembayaran`  "
        query2 = " select 	KdSalesPayment `No Pembayaran`,DATE_FORMAT(TanggalSalesPayment,'%d/%m/%Y') `Tgl Pembayaran`,NamaToko `Nama Toko`,TotalSalesPayment `Total Pembayaran`  "
