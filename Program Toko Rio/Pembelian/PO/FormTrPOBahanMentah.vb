...
Public Class FormTrPOBahanMentah
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            open_subpage("FormTrPOBahanMentahManagement")
            viewAllData("", "")
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            If DataGridView1.RowCount <> 0 Then
                ...
                open_subpage("FormTrPOBahanMentahManagement", selected_cell)
                viewAllData("", "")
            Else
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        If DataGridView1.RowCount <> 0 Then
            ...
            Dim query As String
            query = "select PO.NO_PO,Tanggal_PO,POD.KdBarang,NamaBahanMentah NamaBarang,  " & _
              ...
              "    Join Mssupplier MS On MS.KdSupplier = PO.KdSupplier " & _
              "    Join MsBahanMentah MB On MB.KdBahanMentah = POD.KdBarang where PO.no_po='" & idPrint & "'"
            dropviewM("viewCetakPOus11010001")
            createviewM(query, "viewCetakPOus11010001")
            flagLaporan = "po"
