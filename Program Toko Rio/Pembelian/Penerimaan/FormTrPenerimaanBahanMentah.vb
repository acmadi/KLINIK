...
Public Class FormTrPenerimaanBahanMentah
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            open_subpage("FormTrPenerimaanBahanMentahM")
            viewAllData("", "")
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        If DataGridView1.RowCount <> 0 Then
            ...
            open_subpage("FormTrPenerimaanBahanMentahM", selected_cell)
            viewAllData("", "")
        Else
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        If DataGridView1.RowCount <> 0 Then
            ...
            Dim query As String
            query = "select pb.No_PB,Tanggal_TerimaBarang,PO.NO_PO,Tanggal_PO,POD.KdBarang,NamaBahanMentah NamaBarang,  " & _
           ...
           "  Join MsBahanMentah MB On MB.KdBahanMentah = POD.KdBarang where PB.no_pb='" & idPrint & "'"
