...
Public Class FormTrPenerimaanBarang_
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            open_subpage("FormTrPenerimaanBarangM")
            viewAllData("", "")
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        If DataGridView1.RowCount <> 0 Then
            ...
            open_subpage("FormTrPenerimaanBarangM", selected_cell)
            viewAllData("", "")
        Else
        ...
        Try
            If (DataGridView1.RowCount) Then
                If DataGridView1.CurrentRow.Cells(5).Value = "New" Then
                    Dim selected_cell = DataGridView1.CurrentRow.Cells(0).Value
                    If MsgBox("Anda yakin ingin menghapus kode penerimaan barang " & selected_cell & "?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Confirmation") = MsgBoxResult.Yes Then
