...
Public Class FormTrReturPembelian
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            open_subpage("FormTrReturPembelianM")
            viewAllData("", "")
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        If DataGridView1.RowCount <> 0 Then
           ...
           " Nama, returH.Grandtotal, returH.Status, mp.KDBarang, NamaBarang, harga, disc,qty " & _
           " from  trheaderreturbeli  returH " & _
           " Join trdetailreturbeli retur On returH.KdRetur = retur.KdRetur   " & _
           " join msbarang mp on mp.kdbarang = retur.kdbarang " & _
