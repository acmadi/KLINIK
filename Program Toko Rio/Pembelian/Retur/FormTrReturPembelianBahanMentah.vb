...
Public Class FormTrReturPembelianBahanMentah
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            open_subpage("FormTrReturPembelianBahanMentahM")
            viewAllData("", "")
        ...
        Try
            If Retur_tab.SelectedIndex = 0 Then
                If DataGridView1.RowCount <> 0 Then
                    ...
                    open_subpage("FormTrReturPembelianBahanMentahM", selected_cell)
                Else
    ...
    Private Sub ToolStripButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton1.Click
        If DataGridView1.RowCount <> 0 Then
           ...
           " Nama, returH.Grandtotal, returH.Status, mp.KDBahanMentah `KDBarang`, NamaBahanMentah NamaBarang, harga, disc,qty " & _
           " from  trheaderreturbeli  returH " & _
           " Join trdetailreturbeli retur On returH.KdRetur = retur.KdRetur   " & _
           " join msbahanmentah mp on mp.kdbahanmentah = retur.kdbarang " & _
